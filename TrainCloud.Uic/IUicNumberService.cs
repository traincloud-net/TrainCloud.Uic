...
public interface IUicNumberService
{
    ...
    string GetCarTypeCode(string fullUic);
    ...
    /// <exception cref="ArgumentException">Thrown when the provided UIC number is invalid</exception>
    string GetCountryCode(string fullUic);
    ...
    /// <exception cref="ArgumentException">Thrown when the provided UIC number is invalid</exception>
    string GetCarClassCode(string fullUic);
    ...
    /// <exception cref="ArgumentException">Thrown when the provided UIC number is invalid</exception>
    string GetCarClassSerialNr(string fullUic);
    ...
    /// <exception cref="ArgumentException">Thrown when the provided UIC number is invalid</exception>
    string GetChecksum(string fullUic);
